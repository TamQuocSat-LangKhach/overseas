...
Fk:loadTranslationTable{
  ["os__fuxi"] = "赴曦",
  [":os__fuxi"] = "持恒技，当你进入濒死状态时，或你的装备栏均被废除后，你可以选择一至两项并<a href='os_ruhuan_caoang'>“入幻”</a>并将体力回复至体力上限："..
    "1.获得一个额外回合；2.此次“入幻”时保留〖炽灰〗；3.将手牌摸至X张（X为你的体力上限且至多为5）；"..
    "4.恢复所有装备栏（你的装备栏均被废除时方可选择此项）。",

  ["os_ruhuan_caoang"] = "变身为幻形态：<br><b>煌烛</b>：" ..
    "准备阶段，你可以选择一个已被废除的装备栏，从牌堆或弃牌堆中随机获得一张对应副类别的装备牌"..

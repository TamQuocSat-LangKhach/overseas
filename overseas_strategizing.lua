...
Fk:loadTranslationTable{
  ["os__wangling"] = "王凌",
  ["os__mibei"] = "秘备",
  [":os__mibei"] = "使命技，使用每种类别的牌各至少两张。成功：你获得〖谋立〗。完成前：出牌阶段结束时，若你本回合未使用过牌，则你此回合手牌上限-1并重置〖秘备〗。" .. 
  "<br/><font color='grey'>◆<b>重置〖秘备〗</b>，即清空〖秘备〗所记录的所使用过的牌的类别和数量。<br/><b>使命技(国际服)</b>在成功后失效，完成前有一定的惩罚。</font>",
  ["os__xingqi"] = "星启",
